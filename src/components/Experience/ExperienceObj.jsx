const ExperienceObj = {"exp":[
    {
        ...
        //desc: "Customizing our product according to client needs where in my tech include Java, Javascript and SQL/PLSQL. "
    },
    {
        ...
        duration: "1 month",
       // task:"To perfrom Vulnerability Assessment and Penetration testing",
        desc: `- Tested for various Web Vulnerabilites Manually for the given target.<br>
        - Used results of tools like Nessus, Acuentix, Nmap, Nikto, Burp Suite.<br>
        - Created detailed report of all the vulnerabilites found with their Impact and POC.<br>
         `
    },
    {
        title: "Intern",
       ...
       // task:"To Implement CIS v7.1 Controls",
        desc: `- Studied Network Architecture of the target.<br>
         - Implemented CIS v7.1 Controls on virtual environment.<br>
         - Developed Script to whitelist Usb devices.<br>`
    },
    {
        title: "Bug Hunter",
        company: "Bugcrowd",
        ...
        desc: `- Reported Web/Android Vulnerabilities on more than 50+ targets.<br>
        - Secured more than 50+ Organizations including Google, fastmail, dutch goverment etc.<br>`
